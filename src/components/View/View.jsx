...
function Card({ title, info, controls, children, collapsible = false, defaultOpen = true }) {
        ...
        return (
            <div className='view-wrap'>
                ...
                <div className='two-col'>
                    ...
                    <Card
                        title='Bubble Plots — CC Body Profile'
                        info='Thickness and scalar profile along the body of the corpus callosum; bubble size encodes local thickness. Click the colours in the legend to hide or show each series.'
                    >
