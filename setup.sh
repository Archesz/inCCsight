...
echo ""
echo -e "${YELLOW}  NOTE: If you plan to use CNN 3D segmentation, place the model${NC}"
echo -e "${YELLOW}  checkpoint (.ckpt) in:  methods/CNNBased/peso/${NC}"
echo -e "${YELLOW}  Or run:  python scripts/download_model.py${NC}"
echo ""
