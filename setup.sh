...
echo ""
echo -e "${YELLOW}  ── Model files not tracked by git (place manually) ──────────────${NC}"
echo -e "${YELLOW}  [QC model]  Copy:${NC}"
echo -e "${YELLOW}    vit_with_area_binary_best_combined_auc.pth${NC}"
echo -e "${YELLOW}  to:  methods/models/${NC}"
echo ""
echo -e "${YELLOW}  [CNN model]  Place the 3D segmentation checkpoint (.ckpt) in:${NC}"
echo -e "${YELLOW}    methods/CNNBased/peso/${NC}"
echo -e "${YELLOW}  ──────────────────────────────────────────────────────────────────${NC}"
echo ""
